  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-50">
      ...
      <div className="relative flex min-h-screen group/sidebar">
        <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 z-40 w-[72px] hover:w-[270px] shrink-0 flex-col gap-6 border-r border-white/10 bg-white/5 px-3 hover:px-6 py-6 backdrop-blur-xl transition-all duration-300 ease-out overflow-hidden">
          <Link href="/" className="group flex items-center gap-3 min-w-max">
            <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 to-emerald-400 text-xl font-semibold text-slate-950 shadow-lg shadow-cyan-500/20 transition duration-200 group-hover:scale-[1.02]">
              ⟳
            </div>
            <div className="space-y-0.5 opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-200">
              <div className="font-display text-lg font-semibold tracking-tight">Looply</div>
              <p className="text-xs uppercase tracking-[0.3em] text-slate-400 whitespace-nowrap">reminders</p>
            </div>
          </Link>
